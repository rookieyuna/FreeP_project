							...
							<div class="main-card mb-3 card">
								<div class="card-body">
									<div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
		                                <div class="main-card mb-3 card">
		                                    <div class="card-body"><h5 class="card-title">매장 정보</h5>
		                                        <form:form name="storeFrm" method="post" onsubmit="return validateForm(this);" action="./storeEditAction.do">
		                                            <div class="form-row">
		                                                <div class="col-md-6"> 
	                                                    	...
	                                                    	<table class="mb-0 table table-striped">
																...
																<tr>
																	...
																	<td>
																		<input type="text" class="form-control" name="b_name" style="width:70%;" value="${vo.b_name }"/>
																	</td>
																</tr>
																<tr>
																...
																<tr>
																	...
																	<td>
																		<input type="text" class="form-control" name="latitude" style="width:70%;" value="${vo.latitude }"/>
																	</td>
																</tr>
																<tr>
																	<th class="text-center" style="vertical-align:middle;">위도</th>
																	<td>
																		<input type="text" class="form-control" name="longitude" style="width:70%;" value="${vo.longitude }"/>
																	</td>
																</tr>
																<tr>
