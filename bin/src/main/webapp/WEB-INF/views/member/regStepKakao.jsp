                ...
                <article class="join-area">
                    <div class="join-step2">
                        ...
                        <div class="myinfo-wrap">
                            <div class="form">
                            <form:form name="regFrm" id="regFrm" action="./kakaoAction.do" method="post" onsubmit="return validateForm(this);">
                                 <input type="hidden" id="id" name="id" value="${b }"/>
                                 <input type="hidden" id="pass" name="pass" value="0000" />
                                 <dl>
                              	<div>
	                               <dt>
	                               </dt>
	                               <dd>
	                               <strong>
	                               	FreeP의 원활한 이용을 위하여 추가 정보를 기입 부탁드립니다:)
	                               	</strong>
	                               </dd>
	                              </div>
                              </dl>
                                ...
                                <%--  <dl>
                                    ...
                                    <dd>
                                        <div class="form-item name">
                                            <input type="text" name="id" id="id" maxlength="16" value="${b }">
