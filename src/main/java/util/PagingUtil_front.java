   ...
   public static String pagingImg(
      ...
      */
      ...
      if(intTemp != 1) {
         ...
         //두번째 페이지 블럭부터 출력됨.
         pagingStr += ""
        	+ "<a href='"+page+"nowPage=1' class='btn-prev' title='이전 페이지로 이동'>"
        	+ "<span class='hidden'>이전 페이지로 이동</span></a>";
      ...
      */
      ...
      if(intTemp <= totalPage) {
         ...
         pagingStr += 
        		   "<a href='"+page+"nowPage="+totalPage+"' class='btn-prev' title='다음 페이지로 이동'>"
        		 + "<span class='hidden'>다음 페이지로 이동</span></a>";
