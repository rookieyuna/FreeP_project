				...
				<div class="app-main__inner">
					...
					<div class="main-card mb-3 card">
						<div class="card-body">
							...
							<h5 class="card-title">공지사항 상세보기페이지 - 나중에 디자인 수정 readonly?</h5>
							<form:form name="writeFrm" method="post"
								...
								<div class="position-relative row form-check">
									<div class="col-sm-10 offset-sm-2">
										<button class="btn btn-primary" onclick="location.href='./edit.do?idx=${dto.b_idx}';">수정하기</button>
										<button class="btn btn-success" onclick="location.href='./remove.do?idx=${dto.b_idx}&pre_sfile=${dto.sfile }';">삭제하기</button>
